package com.senacor.tecco.ilms.katas.example.controller;
...
public class UserRestController {
    ...
    public List<User> getUserByLastName(
            @ApiParam(value = "Last name of the required user", required = true)
            @RequestParam(value = "lastName") String lName
    ) {
        return userDB.getUsersByLastName(lName);
    }

    @GetMapping("/{parameter:\\d+}")
    ...
    public User getUserFromId(
            @ApiParam(value = "Id of the required user", required = true)
