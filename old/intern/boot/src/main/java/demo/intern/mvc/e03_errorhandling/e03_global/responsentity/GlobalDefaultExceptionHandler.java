package demo.intern.mvc.e03_errorhandling.e03_global.responsentity;
...
public class GlobalDefaultExceptionHandler {
    ...
    @ResponseBody
    public ResponseEntity<demo.intern.mvc.e03_errorhandling.Error> handleException(HttpServletRequest request, Exception e) throws Exception{
