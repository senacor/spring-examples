...
public class RestTemplateTest {
    ...
    public void testGetForObjectWithURI() {
        ...
        String str = restTemplate.getForObject(uri, // server url
                String.class // an object of type User is expected
        );
    ...
    public void testGetForObjectWithStringAndMap(){
        ...
        String response =
                restTemplate.getForObject("http://localhost:" + port + "/requestMapping/templateParams/{parameter}",
                        String.class,
                        templateParams);
    ...
    public void testGetForEntityWithStringVarargs(){
        ResponseEntity<String> responseEntity =
                restTemplate.getForEntity("http://localhost:" + port + "/requestMapping/templateParams/{parameter}",
                        String.class,
                        "myParameter");
