 ...
 * -------------------------------------------------------------------------------------------
 * Class to define a controller to handle all the exceptions for which no handler is defined.
 * -------------------------------------------------------------------------------------------
 * 1. Use proper annotations to configure it to handle all exceptions.
 */
